...
![картинка выбиралки дизайнов](pics/design-select-1.png)

### Общее:
У большинства обложек можно задать цвет фона из палитры. Для первых двух рядов подойдет белый цвет текста, 

<img src="pics/palette-1.png" alt="палитра" width="50%"><img src="pics/text-select-2.png" alt="палитра" width="50%">

для вторых двух — синий.

<img src="pics/palette-2.png" alt="палитра" width="50%"><img src="pics/text-select-1.png" alt="палитра" width="50%">
...
![картинка](pics/legacy-button.png)
