...
- оформить обложку
- подготовить и загрузить легаси-картинку (для рубрик Интервью, Инструкции, Обзор, Рынок)
- заполнить аннотацию, введение, авторов и экспертов
- оформить текст статьи

## Оформление обложки

Обложки кастомизируются разными дизайнами.

![картинка выбиралки дизайнов]()

### Общее:
У большинства обложек теперь можно задать цвет фона из палитры. Для первых двух рядов подойдет белый цвет текста, для вторых двух — синий.
![картинка]()

Легаси-картинка нужна у рубрик, которые выводятся в слоты с картинкой: Интервью, Инструкции, Обзор, Рынок.
[шаблон]()
...
Ковёр. Картинка занимает всю обложку, все старые картинки 2500x1000 подходят.

Текст. Без картинки. 

Иллюстрация. Картинка с прозрачным фоном в формате png. Если картинка зарезается краями обложки, галочку «с полями» надо убрать.

Фото. У загруженной фотографии настраивается форма овала для того чтобы лучше показать объекты на фото.

Портрет. Загружаем две картинки: фон 2500x1000 и портрет с прозрачным фоном.
